...
ruta_rep_seqs_qzv_relativa <- file.path(ruta_Def_16S_relativa, "rep-seqs.qzv")
ruta_rep_seqs_qzv <- file.path(ruta_Def_16S, "rep-seqs.qzv")

# Definir ruta del archivo .qza
ruta_rep_seqs_qza_relativa <- file.path(ruta_Def_16S_relativa, "rep-seqs.qza")
ruta_rep_seqs_qza <- file.path(ruta_Def_16S, "rep-seqs.qza")

# Definir ruta de salida para el unzip
ruta_Def_16S_unzip <- file.path(ruta_Def_16S_relativa, "unzip")
ruta_unzip_rep_seqs <- file.path(ruta_Def_16S_unzip, "rep-seqs")
...
<ul>
  ...
  <li>
    <strong>Columnas</strong> <strong>&rArr;</strong> cada columna representa una muestra individual incluida en el estudio (por ejemplo, <code>NGS001-23_16S_41</code>, <code>NGS001-23_16S_42</code>, etc.).
  </li>
  <li>
...
ruta_table_qza <- file.path(ruta_Def_16S, "table.qza")
ruta_table_qza_relativa <- file.path(ruta_Def_16S_relativa, "table.qza")
```
...
```{r}
# Definir ruta del archivo .qzv
ruta_table_qzv_relativa <- file.path(ruta_Def_16S_relativa, "table.qzv")
ruta_table_qzv <- file.path(ruta_Def_16S, "table.qzv")

# Definir ruta de salida para el unzip
ruta_Def_16S_unzip <- file.path(ruta_Def_16S_relativa, "unzip")
ruta_unzip_table <- file.path(ruta_Def_16S_unzip, "table")
