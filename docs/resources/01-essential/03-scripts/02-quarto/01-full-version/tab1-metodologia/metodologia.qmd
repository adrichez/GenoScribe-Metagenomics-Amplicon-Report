...
<p>
  A continuación se detalla la organización principal del directorio raíz del pipeline (<code>4-metagenomics</code>). 
...
<p>
  ...
  <a href="https://github.com/adrichez/GenoScribe/blob/main/06-info/0202_METAGENOMICS_AMPLICON_GUIDE.md" target="_blank" class="normalink">GenoScribe: Guía del Pipeline para Metagenómica de Amplicones</a>.
</p>
...
<ul>
  ...
  <li><strong><code>amplicon_type</code></strong> <strong>&rArr;</strong> Indicador numérico que representa el marcador analizado (<strong>1: 16S, 2: 18S, 3: ITS, 4: 16S-18S, 5: 16S-ITS, 6: 18S-ITS, 7: 16S-18S-ITS</strong>). Esta información permite determinar dinámicamente qué resultados se incluirán en el informe.</li>
