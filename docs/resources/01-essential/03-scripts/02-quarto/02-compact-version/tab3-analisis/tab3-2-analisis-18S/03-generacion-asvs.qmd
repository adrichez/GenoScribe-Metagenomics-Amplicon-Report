...
<p>
  Una vez extraído el contenido, se construye una <strong>tabla interactiva</strong> en R a partir del archivo <code>sequences.fasta</code>. Esta tabla resume para cada ASV su identificador (<em>Feature ID</em>), la longitud de la secuencia y la propia secuencia nucleotídica. La longitud de la secuencia permite evaluar si los amplicones cumplen con el tamaño esperado del marcador (por ejemplo, V3-V4 del 18S), y detectar secuencias truncadas o extendidas que podrían indicar errores de secuenciación o quimeras no eliminadas.
</p>
...
<ul>
  ...
  <li>
    <strong>Columnas</strong> <strong>&rArr;</strong> cada columna representa una muestra individual incluida en el estudio (por ejemplo, <code>NGS001-23_18S_41</code>, <code>NGS001-23_18S_42</code>, etc.).
  </li>
  <li>
