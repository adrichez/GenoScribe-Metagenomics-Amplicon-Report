...
ruta_alpha_rarefaction_qzv_relativa <- file.path(ruta_Def_16S_relativa, "alpha-rarefaction.qzv")
ruta_alpha_rarefaction_qzv <- file.path(ruta_Def_16S, "alpha-rarefaction.qzv")

# Definir ruta de salida para el unzip
ruta_Def_16S_unzip <- file.path(ruta_Def_16S_relativa, "unzip")
ruta_unzip_alpha_rarefaction <- file.path(ruta_Def_16S_unzip, "alpha-rarefaction")
...
ruta_core_metrics_results <- file.path(ruta_Def_16S, "core-metrics-results")
ruta_core_metrics_results_relativa <- file.path(ruta_Def_16S_relativa, "core-metrics-results")
